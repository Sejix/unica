...
pub(crate) fn discover_workspace_context(cwd: PathBuf) -> Result<WorkspaceContext, String> {
...
#[cfg(test)]
mod tests {
    use super::discover_workspace_context;
    ...
    fn discovers_workspace_root_and_default_cache_under_build_unica() {
        ...
        let context = discover_workspace_context(nested).unwrap();
